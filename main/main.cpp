...
int main()
{
	...
	wcout << "footvaalvica following onelonecoder's tutorial on youtube" << endl << "Multiple Oscillators with Polyphony" << endl << endl;
	...
	while (1)
	{
		for (int k = 0; k < 16; k++)
		{
			short nKeyState = GetAsyncKeyState((unsigned char)("ZSXCFVGBNJMK\xbcL\xbe\xbd"[k]));
